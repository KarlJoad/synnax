             ...
             (hosts
              (list (openssh-host (name "karl.hallsby.com")
                    ...
                    (openssh-host (name "dubliner")
                                  ...
                                  (user "karl")
                                  (identity-file "~/.ssh/nu"))
                    (openssh-host (name "burrata")
                                  (host-name "burrata.cs.northwestern.edu")
                                  (user "karl")
                                  (identity-file "~/.ssh/nu"))
                    (openssh-host (name "cheesemonger")
                                  (host-name "cheesemonger.cs.northwestern.edu")
                                  (user "generic")
                                  (identity-file "~/.ssh/nu"))
                    (openssh-host (name "fpvm-mac")
                                  (host-name "10.105.115.230")
                                  (user "generic")
                                  (identity-file "~/.ssh/nu")
                                  (port 2222))
             ...
             (extra-config
              (list (plain-file "vim-enable-syntax-highlight"
                    ...
                    (plain-file "vim-autodetect-filetypes"
                                "filetype plugin on")))))
   (simple-service 'nano-config-file-service
                   home-xdg-configuration-files-service-type
                   (list `(".nanorc"
                           ,(plain-file "nanorc"
                                        "# Generated by Guix Home. DO NOT EDIT!
# You can find more options with \"man nanorc\"
...
text = \"#ffffff\""))))
   ...
   (simple-service 'dico-config-files-service
                   home-files-service-type
                   (list `(".dico"
                           ,(plain-file "dico-config"
                                        "# Generated by Guix Home. DO NOT EDIT!
# Use our machine-local dicod instance
open localhost
